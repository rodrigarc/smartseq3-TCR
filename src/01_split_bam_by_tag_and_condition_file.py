...
# Edited: Rodrigo Arcoverde Cerveira                                          #
# =========================================================================== #
""" Splits a multiplexed .bam file into cell-wise .bam files.
    ...
    condition_tag_col : string (optional)
        Name of the column containing the barcodes in 'condition_csv'. Defaults to 'XC_DNBPE'.
    condition_name_col : string (optional)
        Name of the column containing the cell name in 'condition_csv'. Defaults to 'WellID'.
...
if __name__ == '__main__':
    ...
    parser.add_argument('--condition_tag_col', type=str, default='XC_DNBPE_TS', help="Name of the column containing the barcodes in 'condition_csv'. Defaults to 'XC_DNBPE'.")
    parser.add_argument('--condition_name_col', type=str, default='WellID', help="Name of the column containing the cell name in 'condition_csv'. Defaults to 'WellID'.")
    ...
    # Read the barcode file (tab-separated)
    CT = pandas.read_csv(o.condition_csv, sep='\t')
    ...
    # Iterate through the BAM file and split into cell-specific BAM files
